...
def reset_database_and_reports(request):
    ...
    skip_patterns = ['mcp', 'tests/unit', 'test_deepsearch_client', 'test_auto_ingest', 'test_auto_report', 'test_reprocess_embeddings', 'test_pedr_relational', 'test_qdrant_prewarm']
