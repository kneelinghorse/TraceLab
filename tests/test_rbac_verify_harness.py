...
def test_pedr1c_anon_routes_cover_exact_alternate_surface():
    ...
    assert [(method, path) for method, path, _body in routes] == [
        ...
        ("get", "/api/v1/home/attention"),
        ("get", "/api/v1/inbox/summary"),
        ("get", "/api/v1/inbox?section=failures"),
        ("put", "/api/v1/inbox/seen"),
        ("get", "/api/v1/mission-views"),
        ("post", "/api/v1/mission-views"),
        ("put", f"/api/v1/mission-views/{resource_id}"),
        ("delete", f"/api/v1/mission-views/{resource_id}"),
        ("get", "/api/v1/navigation/search?q=rbac"),
        ("get", "/api/v1/collections"),
        ("post", "/api/v1/collections"),
        ("get", f"/api/v1/collections/{resource_id}/documents"),
        ("post", f"/api/v1/collections/{resource_id}/documents"),
        ("delete", f"/api/v1/collections/{resource_id}/documents/{resource_id}"),
        ("get", f"/api/v1/collections/{resource_id}/mission-seed"),
