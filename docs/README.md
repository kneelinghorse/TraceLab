...
Central index for TraceLab docs. Each guide references the canonical templates in `foundational-docs/` so Sprint 04 stays aligned with the shared mission playbook.

| Document | Purpose |
| --- | --- |
| [`docs/getting-started.md`](getting-started.md) | Environment bootstrap + parity validation steps derived from `foundational-docs/roadmap_template.md`. |
| [`docs/mission-protocol-tutorial.md`](mission-protocol-tutorial.md) | Step-by-step Mission Protocol workflow that extends `foundational-docs/tech_arch_template.md`. |
