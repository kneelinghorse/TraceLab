...
const TOOLS: Tool[] = [
  ...
  },
  {
    name: 'list_projects',
    description:
      'List all available projects in TraceLab. Projects organize documents and research.',
    inputSchema: {
      type: 'object',
      properties: {
        page: {
  ...
  },
  {
    ...
    description:
      'List all research collections. Collections group related chunks for synthesis.',
    inputSchema: {
      type: 'object',
      properties: {},
    },
  ...
  },
  {
    ...
    description:
      'Export a collection as a markdown document with all chunks and metadata.',
    inputSchema: {
      type: 'object',
      properties: {
        collection_id: {
  ...
  },
  {
    ...
    description:
      'Create a new collection to organize research chunks. Use this before adding chunks.',
    inputSchema: {
      type: 'object',
      properties: {
        name: {
  ...
  },
  {
    ...
    description:
      'Add a knowledge chunk to a collection. Use chunk_id from search results.',
    inputSchema: {
      type: 'object',
      properties: {
        collection_id: {
  ...
  },
  {
    name: 'synthesize',
    description:
      'Generate a summary or report from a collection of chunks. Includes citations. Optionally save the result as a persistent report.',
    inputSchema: {
      type: 'object',
      properties: {
        collection_id: {
        ...
        prompt: {
          type: 'string',
          description:
            'Optional: Custom prompt for synthesis (e.g., "Summarize the key findings")',
        },
        format: {
          type: 'string',
        ...
        save_as_report: {
          type: 'boolean',
          description:
            'Optional: If true, persist the synthesis result as a report (default: false)',
        },
        report_title: {
          type: 'string',
          description:
            'Optional: Title for the report (required if save_as_report is true)',
          maxLength: 255,
        },
        project_id: {
          type: 'string',
          description:
            'Optional: UUID of project to associate the report with',
        },
      },
      required: ['collection_id'],
    },
  },
  {
    name: 'create_report',
    description:
      'Create a new report by synthesizing content from a collection or specific chunks. Reports are persistent artifacts that survive across sessions.',
    inputSchema: {
      type: 'object',
      properties: {
        title: {
  ...
  },
  {
    name: 'list_reports',
    description:
      'Browse existing reports with optional filtering by project or status.',
    inputSchema: {
      type: 'object',
      properties: {
        project_id: {
  ...
  },
  {
    name: 'export_report',
    description:
      'Export a report as markdown text. Returns the synthesized content directly.',
    inputSchema: {
      type: 'object',
      properties: {
        report_id: {
  ...
  },
  {
    name: 'update_mission',
    description:
      'Modify an existing mission before submission. Change research_depth to control thoroughness, refine the contract-authoring fields (background/focus/references/entities/schemas/thresholds/constraints), or update the objective and success criteria. Only draft missions can be modified. Related tools: create_mission, get_mission, submit_mission.',
    inputSchema: {
      type: 'object',
      properties: {
        mission_id: {
