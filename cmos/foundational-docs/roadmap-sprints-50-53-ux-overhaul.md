...
- **Objects drive composition.** After UX-1, screens are composed with `design_compose(object, context)` and checked with `design_preview` at 390/820/1440 before a build mission starts. Receipts live under `cmos/reports/sprint-N/oods-previews/`.
