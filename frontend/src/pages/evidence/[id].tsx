  ...
  return <div className="mx-auto max-w-4xl space-y-6 px-4 py-8 sm:px-6">
    ...
    {entry && <>
      ...
      <section className="panel space-y-4 p-5" aria-label="Claim and source">
        ...
        <div><h2 className="font-semibold">Supporting snippet</h2>{entry.snippet ? <blockquote className="mt-2 whitespace-pre-wrap break-words border-l-2 border-line-strong pl-4 text-secondary">{entry.snippet}</blockquote> : <p className="mt-2 text-muted">No snippet was captured.</p>}</div>
