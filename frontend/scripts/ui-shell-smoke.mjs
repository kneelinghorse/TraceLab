...
const routes=['/','/graph',`/graph?root=project:${ids.project}`,'/projects','/projects/new',`/projects/${ids.project}`,'/documents',`/documents/${ids.document}`,'/documents/upload','/collections','/collections/new',`/collections/${ids.collection}`,'/reports',`/reports/${ids.report}`,'/missions',`/missions/${ids.mission}`,'/missions/new','/missions/queue','/missions?status=completed&sort=updated_desc','/search','/search/results','/saved-searches','/settings','/invites','/device','/admin/users','/admin/spaces','/console','/console/missions',`/console/missions/${ids.mission}`,'/console/corrections','/404','/evidence','/admin/observability','/admin/corrections',...(evidence.entries[0]?['/evidence/'+evidence.entries[0].id]:[])];
