...
class QualityCheck(Base):
    ...
    )  # 'document' | 'insight' | 'mission' | 'project'
    entity_id = Column(GUID(), nullable=False)

    check_type = Column(
        String, nullable=False
    )  # 'bias_detection' | 'traceability' | 'rigor' | 'synthesis_quality'
    ...
    __table_args__ = (Index("idx_quality_checks_entity", "entity_type", "entity_id"),)
