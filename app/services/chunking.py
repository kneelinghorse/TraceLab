...
class ChunkingService:
    ...
    def chunk_document(self, text: str) -> List[Chunk]:
        ...
        for sentence in sentences:
            ...
            if current_token_count + sentence_tokens > self.max_chunk_size and current_chunk_sentences:
                # Save current chunk if it meets minimum size
                if current_token_count >= self.min_chunk_size:
                    chunk_end = current_chunk_start + sum(len(s) for s in current_chunk_sentences)
